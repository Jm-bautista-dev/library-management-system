...
/* ISA ISA MO TO I RUN PAG NA IMPORT MO NA YUNG
ALTER TABLE member DROP COLUMN balance;

ALTER TABLE book_issue_log DROP COLUMN balance;

DESCRIBE member;

DESCRIBE book_issue_log;

DESCRIBE pending_registrations;

ALTER TABLE member MODIFY id INT(11) NOT NULL AUTO_INCREMENT;
...
/* isa isa mo to i run pag tapos mo iimport yung database
ALTER TABLE member DROP COLUMN balance;
